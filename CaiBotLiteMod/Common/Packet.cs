    ...
    public override bool HijackGetData(ref byte messageType, ref BinaryReader Reader, int playerNumber)
    {
        ...
        switch (messageType)
        {
            ...
            case MessageID.RequestWorldData:
                if (ModContent.GetInstance<ServerConfig>().EnableWhiteList && !player!.SscLogin)
                {
                    return true;
                }
                break;
            case MessageID.SyncPlayer:
                ...
                if (!ModContent.GetInstance<ServerConfig>().EnableWhiteList || !player!.SscLogin || player.IsLoggedIn)
                {
                    return false;
                }
            ...
            case MessageID.ClientUUID:
                ...
                if (!ModContent.GetInstance<ServerConfig>().EnableWhiteList)
                {
                    return false;
                }
